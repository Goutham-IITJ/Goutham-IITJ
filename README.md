# 💫 About Me:
Hey there...! <br> I'm Goutham — a web developer focused on the MERN stack, with a keen interest in data science and machine learning. <br><br>🤖 Robotics Enthusiast: I make robots smarter (or at least try to).<br> I build and simulate intelligent robotic systems, with experience in ROS2, Gazebo, SLAM, and multi-robot coordination.<br>💡 Product Management Curious: Because tech needs vision, not just code.<br>From scraping industrial data to launching RC planes, I enjoy solving real-world problems through thoughtful tech and design.<br>I thrive on ambitious projects, caffeine, and the illusion of free time. Always open to collaborations.<br><br>Let's build something awesome. 
...
![](https://github-contributor-stats.vercel.app/api?username=Goutham-IITJ&limit=5&theme=dark&combine_all_yearly_contributions=true)

---
[![](https://visitcount.itsvg.in/api?id=Goutham-IITJ&icon=0&color=0)](https://visitcount.itsvg.in)
