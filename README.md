# 💫 About Me:
Hey there...! 👋<br>I'm Goutham, an engineer, artist, and accidental bug creator. <br><br>🤖 Robotics Enthusiast: I make robots smarter (or at least try to).<br>🎨 Fine Arts Fanatic: When I'm not training neural networks, I'm sketching them.<br>💡 Product Management Curious: Because tech needs vision, not just code.<br>🛩 RC Plane Builder: Yes, I made one. No, it didn’t crash (on purpose).<br>I thrive on ambitious projects, caffeine, and the illusion of free time. Always open to collaborations.<br><br>Let's build something awesome. 💻✨
